...
def get_env_file_path():
    if os.name == "nt":  # Windows
        config_dir = Path(os.getenv("APPDATA", "C:\\Users\\Default\\AppData\\Roaming")) / PROJECT_NAME
    else:  # Linux/macOS
        config_dir = Path(os.getenv("XDG_CONFIG_HOME", "~/.config")).expanduser() / PROJECT_NAME
